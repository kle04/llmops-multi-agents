...
### Delete Current User
Permanently delete your account and all associated data (sessions, messages).
...
```
*Note: Titles are automatically generated by the LLM after the first few messages.*
